...
# PATH
set -x PATH $HOME/.cargo/bin $HOME/.bin /usr/local/go/bin /usr/local/bin /usr/local/sbin /opt/homebrew/bin /bin /usr/bin /sbin /usr/sbin /usr/local/sessionmanagerplugin/bin $HOME/google-cloud-sdk/bin $HOME/.local/bin /opt/homebrew/opt/go@1.22/bin
