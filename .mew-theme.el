;;;
;;; Copy this contents to "~/.mew.el".
;;;
;;; Or, copy this file to a file, say "~/.mew-theme.el" and
;;; put the following to "~/.mew.el".
...
(mew-setface-bold header-subject
  :tty "yellow" :light "Firebrick" :dark "OrangeRed")

(mew-setface-bold header-from
  :tty "#332200" :light "DarkOrange4" :dark "Gold")

(mew-setface-bold header-date
  :tty "cyan" :light "ForestGreen" :dark "LimeGreen")
...
(mew-setface-bold header-important
  :tty "blue" :light "MediumBlue" :dark "SkyBlue")
...
(mew-setface body-cite1
  :tty "red" :light "ForestGreen" :dark "LimeGreen")
