...
(defun color-theme-thirai ()
  "Color theme by thirai, created 2012/01/11."
  (interactive)
  (color-theme-install
   '(color-theme-arjen
     ...
     (gnus-header-from-face ((t (:bold nil :foreground "green"))))
     ...
     (modeline ((t (:background "#0087ff" :foreground "white" :box (:line-width 1 :style released-button)))))
     (modeline-buffer-id ((t (:background "orange" :foreground "white"))))
     (modeline-mousable ((t (:background "#d75f00" :foreground "white"))))
     (modeline-mousable-minor-mode ((t (:background "#d75f00" :foreground "white"))))
     ...
     (toolbar ((t (nil))))
     (underline ((t (:foreground "orange" :underline t))))
